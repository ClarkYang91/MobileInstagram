...
public class ProfileShareActivity extends AppCompatActivity{
    ...
    private Context mContext = ProfileShareActivity.this;
    ...
    private void setupViewPager(){
        ...
        adapter.addFragment(new ProfilePhotoFragment());
    ...
    public boolean checkPermissions(String permission){
        ...
        int permissionRequest = ActivityCompat.checkSelfPermission(ProfileShareActivity.this, permission);
